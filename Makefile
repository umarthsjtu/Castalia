...
#  opp_makemake -f -r --deep -o CastaliaBin -u Cmdenv -P /home/marc/Bureau/PFE/Castalia-3.2 -M release -X Simulations -X out -X bin
#
...
OBJS = \
    ...
    $O/src/node/application/ysapp/ystest.o \
    ...
    $O/src/node/communication/routing/flooding/Flooding.o \
    ...
    $O/src/node/mobilityManager/banMobilityManager/BanMobilityManager.o \
    $O/src/node/mobilityManager/banMobilityManager/Coord.o \
    $O/src/node/mobilityManager/banMobilityManager/NodePositions.o \
    ...
    $O/src/node/mobilityManager/traingleMobilityManager/traingleMobilityManager.o \
    ...
    $O/src/routingControl/RoutingControl.o \
    ...
    $O/src/node/communication/routing/flooding/FloodingPacket_m.o \
    ...
    $O/src/routingControl/RoutingControlMessages_m.o \
...
MSGFILES = \
    ...
    src/node/communication/routing/flooding/FloodingPacket.msg \
    ...
    src/routingControl/RoutingControlMessages.msg \
...
clean:
	...
	-rm -f src/node/application/ysapp/*_m.cc src/node/application/ysapp/*_m.h
	...
	-rm -f src/node/communication/routing/flooding/*_m.cc src/node/communication/routing/flooding/*_m.h
	...
	-rm -f src/node/mobilityManager/banMobilityManager/*_m.cc src/node/mobilityManager/banMobilityManager/*_m.h
	...
	-rm -f src/node/mobilityManager/traingleMobilityManager/*_m.cc src/node/mobilityManager/traingleMobilityManager/*_m.h
	...
	-rm -f src/routingControl/*_m.cc src/routingControl/*_m.h
...
depend:
	$(MAKEDEPEND) $(INCLUDE_PATH) -f Makefile -P\$$O/ -- $(MSG_CC_FILES)  ./*.cc src/*.cc src/helpStructures/*.cc src/node/*.cc src/node/application/*.cc src/node/application/bridgeTest/*.cc src/node/application/connectivityMap/*.cc src/node/application/simpleAggregation/*.cc src/node/application/throughputTest/*.cc src/node/application/valuePropagation/*.cc src/node/application/valueReporting/*.cc src/node/application/ysapp/*.cc src/node/communication/*.cc src/node/communication/mac/*.cc src/node/communication/mac/baselineBanMac/*.cc src/node/communication/mac/bypassMac/*.cc src/node/communication/mac/mac802154/*.cc src/node/communication/mac/tMac/*.cc src/node/communication/mac/tunableMac/*.cc src/node/communication/radio/*.cc src/node/communication/routing/*.cc src/node/communication/routing/bypassRouting/*.cc src/node/communication/routing/flooding/*.cc src/node/communication/routing/multipathRingsRouting/*.cc src/node/mobilityManager/*.cc src/node/mobilityManager/banMobilityManager/*.cc src/node/mobilityManager/lineMobilityManager/*.cc src/node/mobilityManager/noMobilityManager/*.cc src/node/mobilityManager/traingleMobilityManager/*.cc src/node/resourceManager/*.cc src/node/sensorManager/*.cc src/physicalProcess/*.cc src/physicalProcess/carsPhysicalProcess/*.cc src/physicalProcess/customizablePhysicalProcess/*.cc src/routingControl/*.cc src/wirelessChannel/*.cc
...
$O/src/node/application/valueReporting/ValueReportingPacket_m.o: src/node/application/valueReporting/ValueReportingPacket_m.cc \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/valueReporting/ValueReportingPacket_m.h
$O/src/node/application/ysapp/ystest.o: src/node/application/ysapp/ystest.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  ...
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/application/ysapp/ystest.h \
  src/node/communication/mac/MacPacket_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/communication/radio/RadioControlMessage_m.h \
...
$O/src/node/communication/routing/bypassRouting/BypassRoutingPacket_m.o: src/node/communication/routing/bypassRouting/BypassRoutingPacket_m.cc \
  src/node/communication/routing/bypassRouting/BypassRoutingPacket_m.h \
  src/node/communication/routing/RoutingPacket_m.h
$O/src/node/communication/routing/flooding/Flooding.o: src/node/communication/routing/flooding/Flooding.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/communication/routing/RoutingPacket_m.h \
  ...
  src/node/communication/radio/Radio.h \
  src/CastaliaMessages.h \
  src/node/communication/routing/flooding/FloodingPacket_m.h \
  src/node/communication/mac/MacPacket_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/helpStructures/TimerService.h \
  src/node/communication/routing/flooding/Flooding.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/communication/routing/flooding/FloodingPacket_m.o: src/node/communication/routing/flooding/FloodingPacket_m.cc \
  src/node/communication/routing/RoutingPacket_m.h \
  src/node/communication/routing/flooding/FloodingPacket_m.h
...
$O/src/node/mobilityManager/VirtualMobilityManager.o: src/node/mobilityManager/VirtualMobilityManager.cc \
  src/helpStructures/CastaliaModule.h \
  src/node/mobilityManager/banMobilityManager/Coord.h \
  src/node/mobilityManager/banMobilityManager/NodePositions.h \
  src/CastaliaMessages.h \
  src/helpStructures/DebugInfoWriter.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/node/mobilityManager/VirtualMobilityManager.h
$O/src/node/mobilityManager/banMobilityManager/BanMobilityManager.o: src/node/mobilityManager/banMobilityManager/BanMobilityManager.cc \
  src/node/mobilityManager/banMobilityManager/BanMobilityManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/mobilityManager/banMobilityManager/Coord.h \
  src/node/mobilityManager/banMobilityManager/NodePositions.h \
  src/node/mobilityManager/MobilityManagerMessage_m.h \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/mobilityManager/banMobilityManager/Coord.o: src/node/mobilityManager/banMobilityManager/Coord.cc \
  src/node/mobilityManager/banMobilityManager/Coord.h
$O/src/node/mobilityManager/banMobilityManager/NodePositions.o: src/node/mobilityManager/banMobilityManager/NodePositions.cc \
  src/node/mobilityManager/banMobilityManager/Coord.h \
  src/node/mobilityManager/banMobilityManager/NodePositions.h
...
$O/src/node/mobilityManager/noMobilityManager/NoMobilityManager.o: src/node/mobilityManager/noMobilityManager/NoMobilityManager.cc \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/mobilityManager/traingleMobilityManager/traingleMobilityManager.o: src/node/mobilityManager/traingleMobilityManager/traingleMobilityManager.cc \
  src/helpStructures/CastaliaModule.h \
  src/node/mobilityManager/MobilityManagerMessage_m.h \
  src/CastaliaMessages.h \
  src/helpStructures/DebugInfoWriter.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/node/mobilityManager/traingleMobilityManager/traingleMobilityManager.h \
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
...
$O/src/physicalProcess/customizablePhysicalProcess/CustomizablePhysicalProcess.o: src/physicalProcess/customizablePhysicalProcess/CustomizablePhysicalProcess.cc \
  ...
  src/helpStructures/DebugInfoWriter.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/routingControl/RoutingControl.o: src/routingControl/RoutingControl.cc \
  src/helpStructures/CastaliaModule.h \
  src/CastaliaMessages.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/routingControl/RoutingControl.h
$O/src/routingControl/RoutingControlMessages_m.o: src/routingControl/RoutingControlMessages_m.cc \
  src/routingControl/RoutingControlMessages_m.h
